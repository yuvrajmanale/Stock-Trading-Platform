      ...
      <div className=" row p-5 mt-5 border-top text-muted" style={{ lineHeight: "1.8", fontSize: "1.2rem" }}>
        <div className="col-6 p-5">
         ...
         <div className="col-6 p-5">
          ...
          <p><a href="https://www.zerodha.com/rainmatter" target="_blank" rel="noopener noreferrer" style={{textDecoration:"none"}}>Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.</p>
